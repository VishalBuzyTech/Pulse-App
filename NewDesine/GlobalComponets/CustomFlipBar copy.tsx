...
const CustomFlipBar: React.FC<LeadStatusProps> = ({ selectedCard, setSelectedCard, metaData,leadData,dataMyLead,teamLeadData,myLeadProspect,myLeadStageOpportunity,myLeadStageClosure,allContect,userType,myleadSatgeShow }) => {
...
console.log(myleadSatgeShow,'myleadSatgeShowmyleadSatgeShow::::::::::::::::');
  ...
  console.log(metaData,"page 2222222222")
  const defaultWidth = 80;
  const data = useMemo(
    () => [
      { id: 1, title: "All Leads", count: metaData || 0 },
      { id: 3, title: "All", count: metaData || 0 },
      {id:7, title: "Leads", count: metaData || 0 },
      { id: 2, title: "Contact", count: metaData || 0 },
      { id: 4, title: "Prospect", count:metaData || 0 },
      { id: 5, title: "Opportunity", count: metaData || 0 },
      { id: 6, title: "Closure", count: metaData || 0 },
